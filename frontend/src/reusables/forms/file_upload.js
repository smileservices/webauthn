    ...
    function existingFile(file) {
        return (
            <div key={makeId(3)} className="file-container">
                <div className="toolbar thumbnail">
                    <span onClick={() => deleteAction(file)} className="icon-close danger"></span>
                </div>
    ...
    return (
        <div className="form-group image-upload">
            ...
            <div className="dropzone-input">
                ...
                {request.error ? <Alert text={request.error} type="danger" stick={true}/> : ""}
                {deleteReq.error ? <Alert text={deleteReq.error} type="danger" stick={true}/> : ""}
